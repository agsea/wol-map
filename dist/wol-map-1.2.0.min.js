...
!function(e){e.DragHandler=e.DragHandler||{},DragHandler.startDrag=function(e,t){var a=$(t),r=a.parent(),o=e.clientX||e.pageX||e.screenX,n=e.clientY||e.pageY||e.screenY,i=parseFloat(r.css("margin-left")),l=parseFloat(r.css("margin-top")),s=o-i-parseFloat(a.css("margin-left")),c=n-l-parseFloat(a.css("margin-top"));a.attr("conMarginL",i),a.attr("conMarginT",l),a.attr("mouseOffsetX",s),a.attr("mouseOffsetY",c)},DragHandler.dragging=function(e,t,a){var r=$(t),o=e.clientX||e.pageX||e.screenX,n=e.clientY||e.pageY||e.screenY,i=r.attr("conMarginL"),l=r.attr("conMarginT"),s=o-i-r.attr("mouseOffsetX"),c=n-l-r.attr("mouseOffsetY");(r.css("margin-left",s),r.css("margin-top",c),a instanceof Function)&&a(r,{dragMarginL:s,dragMarginT:c})},DragHandler.endDrag=function(e,t){},DragHandler.allowDrop=function(e){e.preventDefault()}}(window),function(e){e.wol=e.wol||{};function t(e,t){var a,r,o,n,i={},l=t.exclude;l=(l=l||[])instanceof Array?l:[l];for(var s=0;s<e.length;s++){a=e[s];for(var c=0;c<l.length;c++)if(a.get("name")===l[c]){o=!0;break}o?o=!1:(void 0===i[r=a.get("group")]&&(i[r]=[]),n={name:a.get("name"),label:a.get("label"),type:a.get("type"),zIndex:a.getZIndex(),checked:a.getVisible()},i[r].push(n))}return i}function a(e){var t,a,r=[];for(var o in e)if("undefined"===o){a=e[o];for(var n=0;n<a.length;n++)t={open:!0,checked:a[n].checked,iconSkin:"layerIcon",name:a[n].label,layerName:a[n].name,type:a[n].type,zIndex:a[n].zIndex},r.push(t)}else{a=e[o],t={open:!1,nocheck:!0,iconSkin:"layersIcon",name:o,children:[]};for(n=0;n<a.length;n++)t.children.push({open:!0,checked:a[n].checked,iconSkin:"layerIcon",name:a[n].label,layerName:a[n].name,type:a[n].type,zIndex:a[n].zIndex});r.push(t)}return r}wol.LayerManager=function(e){var r,o,n=e.getMap(),i={exclude:[]};function l(t){var a={view:{selectedMulti:!1},edit:{enable:!0},check:{enable:!0},data:{simpleData:{enable:!0}},callback:{beforeEditName:function(e,t){return $.fn.zTree.getZTreeObj("treeDemo").selectNode(t),!1},onClick:function(e,t,a){var r="#"+a.tId+"_a";$(r).removeClass("curSelectedNode")},onCheck:function(t,a,r){var o=r.layerName,n=e.getLayerByName(o);r.checked?n.setVisible(!0):n.setVisible(!1)}}};$.fn.zTree.init($("#wolLayerTree0"),a,t)}function s(){var e=t(r,i);l(o=a(e))}this.init=function(c){var u;if(void 0===(i=wol.util.extend(i,c)).target){if((u=$(e.getMap().getTargetElement())).attr("has-tree"))return;u.append('<div class="layer-manager-container in-map pos-absolute" draggable="true" ondragstart="DragHandler.startDrag(event, this)"ondrag="DragHandler.dragging(event, this)" ondragend="DragHandler.endDrag(event, this)"><h4>图层控制</h4><div><ul id="wolLayerTree0" class="ztree"></ul></div></div>')}else{if((u=$("#"+i.target)).attr("has-tree"))return;u.append('<div class="layer-manager-container normal"><div><ul id="wolLayerTree0" class="ztree"></ul></div></div>')}u.attr("has-tree",!0);var g=t(r=n.getLayers().getArray(),i);l(o=a(g)),e.register("addLayer",s),e.register("removeLayer",s)},this.getMap=function(){return n},this.getLayers=function(){return r},this.getTreeData=function(){return o}}}(window),function(e){e.wol=e.wol||{},wol.Locator=function(e){var t,a=e,r={STATIC:new ol.style.Style({stroke:new ol.style.Stroke({color:"#00afcc",width:2}),fill:new ol.style.Fill({color:"#00e3ff"}),image:new ol.style.Circle({stroke:new ol.style.Stroke({color:"#8fedce",width:2}),fill:new ol.style.Fill({color:"#00c38a"}),radius:8})}),FLASH:new ol.style.Style({stroke:new ol.style.Stroke({color:"#ff93a8",width:2}),fill:new ol.style.Fill({color:"#ff607f"}),image:new ol.style.Circle({stroke:new ol.style.Stroke({color:"#ff93a8",width:2}),fill:new ol.style.Fill({color:"#ff607f"}),radius:8})})};this.getMapViewer=function(){return a},this.getLocateLayer=function(){return t},this.getLocateSource=function(){return t.getSource()},this.getStaticStyle=function(){return r.STATIC},this.setStaticStyle=function(e){r.STATIC=e,this.getLocateLayer().setStyle(e)},this.getFlashStyle=function(){return r.FLASH},this.setFlashStyle=function(e){r.FLASH=e},this.getPiStrokeColor=function(){return r.FLASH.getImage().getStroke().getColor()},this.getPiFillColor=function(){return r.FLASH.getImage().getFill().getColor()},this.getPiRadius=function(){return r.FLASH.getImage().getRadius()},this.getLsStrokeColor=function(){return r.FLASH.getStroke().getColor()},this.getPlStrokeColor=function(){return r.FLASH.getStroke().getColor()},this.getPlFillColor=function(){return r.FLASH.getFill().getColor()},t=wol.util.createVectorLayer({name:"locateLayer"+(new Date).getTime(),label:"定位图层",style:r.STATIC,updateWhileAnimating:!0,zIndex:30}),e.addLayer(t)},wol.Locator.prototype.locate=function(e,t){e.get("locating")?console.warn("The feature is being located."):(e.set("locating",!0),t=wol.util.extend(!0,{duration:0,times:3,autoView:!0},t),this.locateProxy(e,t.duration,t.times,t.autoView))},wol.Locator.prototype.locateProxy=function(e,t,a,r){r&&this.getMapViewer().getView().fit(e.getGeometry(),{size:mapViewer.getMap().getSize(),padding:[50,50,50,50],duration:600});var o=this,n=!1,i=e.clone(),l="locate"+i.getGeometry().getType(),s=i.getGeometry().getType();if("Point"===s||"LineString"===s||"Polygon"===s)if("Point"===s&&(n=!1),a>0){var c=0,u=setInterval(function(){if(++c>a-1)return clearInterval(u),e.set("locating",!1),void(n&&o.getLocateSource().removeFeature(i));o[l](i,t)},t);o[l](i,t)}else setTimeout(function(){e.set("locating",!1),n&&o.getLocateSource().removeFeature(i)},t);else console.error("Unsupported type of feature to locate.")},wol.Locator.prototype.locatePoint=function(e,t){var a,r=this,o=r.getMapViewer().getMap(),n=(t=t,(new Date).getTime());a=o.on("postcompose",function(i){var l=i.vectorContext,s=i.frameState,c=e.getGeometry(),u=s.time-n,g=u/t,m=r.createPointFlashStyle(g,5,r.getPiRadius());l.setStyle(m),l.drawGeometry(c),u>t?ol.Observable.unByKey(a):o.render()}),o.render()},wol.Locator.prototype.locateLineString=function(e,t){var a,r=this,o=r.getMapViewer().getMap(),n=(t=t,(new Date).getTime());a=o.on("postcompose",function(i){var l=i.vectorContext,s=i.frameState,c=e.getGeometry(),u=s.time-n,g=u/t,m=r.createLineFlashStyle(g);if(l.setStyle(m),l.drawGeometry(c),u>t)return ol.Observable.unByKey(a),void o.render();o.render()}),o.render()},wol.Locator.prototype.locatePolygon=function(e,t){var a,r=this,o=r.getMapViewer().getMap(),n=(t=t,(new Date).getTime());a=o.on("postcompose",function(i){var l=i.vectorContext,s=i.frameState,c=e.getGeometry(),u=s.time-n,g=u/t,m=r.createAreaFlashStyle(g);if(l.setStyle(m),l.drawGeometry(c),u>t)return ol.Observable.unByKey(a),void o.render();o.render()}),o.render()},wol.Locator.prototype.createPointFlashStyle=function(e,t,a){var r=ol.easing.easeOut(e)*a+t,o=ol.easing.easeOut(1-e),n=wol.util.getColorArray(this.getPiStrokeColor());return new ol.style.Style({image:new ol.style.Circle({radius:r,snapToPixel:!1,stroke:new ol.style.Stroke({color:"rgba("+n[0]+", "+n[1]+", "+n[2]+", "+o+")",width:2.2})})})},wol.Locator.prototype.createLineFlashStyle=function(e){var t=ol.easing.upAndDown(1-e),a=wol.util.getColorArray(this.getLsStrokeColor());return new ol.style.Style({stroke:new ol.style.Stroke({color:"rgba("+a[0]+", "+a[1]+", "+a[2]+", "+t+")",width:4})})},wol.Locator.prototype.createAreaFlashStyle=function(e){var t=ol.easing.upAndDown(e),a=wol.util.getColorArray(this.getPlStrokeColor()),r=wol.util.getColorArray(this.getPlFillColor());return new ol.style.Style({stroke:new ol.style.Stroke({color:"rgba("+a[0]+", "+a[1]+", "+a[2]+", "+t+")",width:4}),fill:new ol.style.Fill({color:"rgba("+r[0]+", "+r[1]+", "+r[2]+", "+t+")"})})}}(window),function(e){e.wol=e.wol||{};var t,a,r={slow:1,normal:5,fast:10},o=decodeURI((t=document.getElementsByTagName("script"),(a=t[t.length-1]).hasAttribute?a.src:a.getAttribute("src"))).split("/");o.pop();var n=o.join("/")+"/image/drone.gif";function i(e){e.animateParam.flashCoords=[e.animateParam.srcCoords[0]],e.animateParam.index=0}function l(e,t,a){var r=e.getView(),o=50;a&&(o=a<=5?100:a>5&&a<=9?50:0),a&&o>0?r.animate({center:t},{duration:o}):(r.setZoom(15),r.setCenter(t))}function s(e,t,a){var r,o,n=e[0],i=e[1],l=t[0],s=t[1],c=[e];if(i===s)for(r=n+a,o=i;r<l;)c.push([r,o]),r+=a;else if(n===l)for(r=n,o=i+a;o<s;)c.push([r,o]),o+=a;else{var u=(s-i)/(l-n),g=a/Math.pow(1+u*u,.5),m=g*u;for(r=n+g,o=i+m;r<l;)c.push([r,o]),r+=g,o+=m}return c.push(t),c}wol.Tracer=function(e){var t,a,o,l,c,u,g=e,m={source:null,speed:r.normal,afterInitialize:function(){},afterStart:function(){},afterComplete:function(){},icon:n,iconClass:"",iconSize:40,iconOpacity:1,ifDynamicTrack:!1,ifLocate:!1},p={STATIC_LINE:new ol.style.Style({stroke:new ol.style.Stroke({color:"#374f62",width:2,lineDash:[6,4]})}),FLASH_LINE:new ol.style.Style({stroke:new ol.style.Stroke({color:"#23e6a1",width:3})}),FLASH_POINT:(c={src:n,opacity:.95},u={anchor:[.5,1],anchorXUnits:"fraction",anchorYUnits:"fraction",src:n,scale:1,opacity:1},c=wol.util.extend(u,c),new ol.style.Style({image:new ol.style.Icon({anchor:c.anchor,anchorXUnits:c.anchorXUnits,anchorYUnits:c.anchorYUnits,src:c.src,scale:c.scale,opacity:c.opacity})}))};this.status={initialize:!1,start:!1,animating:!1,complete:!1},this.timer=null,this.animateParam={},this.init=function(n){this.status.initialize?console.error("轨迹已初始化"):(function(e,t){var n=e.source;if(!(null!==n&&n instanceof ol.Feature&&n.getGeometry()instanceof ol.geom.LineString))return void console.error("参数错误");var c=e.speed;c="slow"===c?r.slow:"normal"===c?r.normal:"fast"===c?r.fast:isNaN(c)?1:parseFloat(c);e.speed=c,a=n;var u=n.getGeometry().getCoordinates(),g=function(e,t){var a=e.length;{if(a>=2){for(var r,o=0,n=[];o<a-1;o++)r=s(e[o],e[o+1],t),n=n.concat(r);return n}throw new Error("至少包含两个点")}}(u,e.speed);o=new ol.Feature(new ol.geom.LineString([u[0]])),l=new ol.Overlay({element:(m={icon:e.icon,clas:e.iconClass,size:e.iconSize,opacity:e.iconOpacity},f=document.createElement("div"),f.style.width=m.size+"px",f.style.height=m.size+"px",f.className=m.clas,f.style.background="url("+m.icon+") no-repeat",f.style.backgroundSize=m.size+"px",f.style.opacity=m.opacity,f),position:u[0],positioning:"center-center"}),a.setStyle(p.STATIC_LINE),o.setStyle(p.FLASH_LINE),t.animateParam.speed=e.speed,t.animateParam.srcCoords=g,t.animateParam.tempCoord=g[0],t.animateParam.coordLen=g.length,t.animateParam.flashLineGeom=o.getGeometry(),t.animateParam.flashPointOverlay=l,t.animateParam.afterInitialize=e.afterInitialize,t.animateParam.afterStart=e.afterStart,t.animateParam.afterComplete=e.afterComplete,t.animateParam.ifDynamicTrack=e.ifDynamicTrack,i(t);var m,f}(n=wol.util.extend(m,n),this),t=wol.util.createVectorLayer({name:"traceLayer"+(new Date).getTime(),label:"轨迹图层",style:p.STATIC,features:[a,o],updateWhileAnimating:!0,updateWhileInteracting:!0,zIndex:25}),e.addLayer(t),e.getMap().addOverlay(l),this.status.initialize=!0,this.animateParam.afterInitialize(),n.ifLocate&&this.getMapViewer().panTo(this.animateParam.tempCoord,400))},this.getMapViewer=function(){return g},this.getTraceLayer=function(){return t},this.getTraceSource=function(){return t.getSource()},this.getTraceLine=function(){return a},this.getFlashLine=function(){return o},this.getFlashPoint=function(){}},wol.Tracer.prototype.play=function(){var e=this,t=0;if(e.status.initialize){if(e.status.start){if(e.status.animating)return void console.info("动画正在播放");if(e.status.complete)return void console.info("动画已结束")}else e.status.start=!0,e.animateParam.afterStart(),e.animateParam.ifDynamicTrack?e.getMapViewer().getMap().getView().setZoom(15):(l(e.getMapViewer().getMap(),e.animateParam.tempCoord,e.animateParam.speed),t=100);setTimeout(function(){e.status.animating=!0,e.timer=setInterval(function(){var t,a,r;e.animateParam.index<e.animateParam.coordLen-1?(e.animateParam.tempCoord=e.animateParam.srcCoords[e.animateParam.index+1],e.animateParam.flashCoords.push(e.animateParam.tempCoord),e.animateParam.flashLineGeom.setCoordinates(e.animateParam.flashCoords),e.animateParam.flashPointOverlay.setPosition(e.animateParam.tempCoord),e.animateParam.ifDynamicTrack?e.getMapViewer().panTo(e.animateParam.tempCoord,0):(t=e.getMapViewer().getMap(),a=e.animateParam.tempCoord,r=t.getView().calculateExtent(t.getSize()),ol.extent.containsCoordinate(r,a)||l(e.getMapViewer().getMap(),e.animateParam.tempCoord,e.animateParam.speed)),e.animateParam.index++):(clearInterval(e.timer),e.status.animating=!1,e.status.complete=!0,e.animateParam.afterComplete())},5)},t)}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.pause=function(){this.status.animating?(clearInterval(this.timer),this.status.animating=!1):console.error("动画未处于播放状态")},wol.Tracer.prototype.reset=function(){var e=this;if(e.status.initialize){clearInterval(e.timer),e.status.start=!1,e.status.animating=!1,e.status.complete=!1,i(e);var t=e.animateParam.srcCoords[0];e.animateParam.flashLineGeom.setCoordinates(e.animateParam.flashCoords),e.animateParam.flashPointOverlay.setPosition(t),e.animateParam.tempCoord=t,e.getMapViewer().panTo(t,600)}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.clear=function(){var e=this;if(e.status.initialize){clearInterval(e.timer),e.status.initialize=!1,e.status.start=!1,e.status.animating=!1,e.status.complete=!1,i(e);var t=e.getTraceSource();t.removeFeature(e.getTraceLine()),t.removeFeature(e.getFlashLine()),t.removeFeature(e.getFlashPoint())}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.setStaticStyle=function(e){this.getTraceLine().setStyle(e)},wol.Tracer.prototype.setFlashStyle=function(e){this.getFlashLine().setStyle(e)}}(window),function(e){e.wol=e.wol||{},e.wol.util=e.wol.util||{},wol.util.styles={DEFAULT_STYLE:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(0, 191, 255, 0.5)"}),image:new ol.style.Circle({fill:new ol.style.Fill({color:"#00bfff"}),stroke:new ol.style.Stroke({color:"#bdecff",width:2}),radius:8}),stroke:new ol.style.Stroke({color:"#00bfff",width:3})}),TEXT_STYLE:new ol.style.Style({text:new ol.style.Text({text:"",offsetY:18,font:"14px 微软雅黑",textAlign:"center",fill:new ol.style.Fill({color:"#2d2d2d"})})}),MASK_BLACK:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(0, 0, 0, 0.5)"})})},wol.util.createVectorLayer=function(e){var t={name:void 0,label:"",style:wol.util.styles.DEFAULT_STYLE,features:[],updateWhileAnimating:!0,updateWhileInteracting:!1,useSpatialIndex:!1,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var a=new ol.layer.Vector({source:new ol.source.Vector({features:e.features,useSpatialIndex:e.useSpatialIndex}),style:e.style,updateWhileAnimating:e.updateWhileAnimating,updateWhileInteracting:e.updateWhileInteracting,opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return a.set("name",e.name),a.set("label",e.label),a.set("group",e.group),a.set("type","Vector"),a},wol.util.createClusterLayer=function(e){var t={},a={name:void 0,label:"",styleFunction:function(e){var a=e.get("features").length,r=t[a];return r||(r=new ol.style.Style({image:new ol.style.Circle({radius:10,stroke:new ol.style.Stroke({color:"#fff"}),fill:new ol.style.Fill({color:"#3399CC"})}),text:new ol.style.Text({text:a.toString(),fill:new ol.style.Fill({color:"#fff"})})}),t[a]=r),r},features:[],updateWhileAnimating:!0,updateWhileInteracting:!1,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(a,e);var r=new ol.layer.Vector({source:new ol.source.Cluster({distance:40,source:new ol.source.Vector({features:e.features})}),style:function(t,a){return e.styleFunction(t,a)},updateWhileAnimating:e.updateWhileAnimating,updateWhileInteracting:e.updateWhileInteracting,opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","Cluster"),r},wol.util.createXYZLayer=function(e){var t={name:void 0,label:"",url:"",crossOrigin:void 0,minZoom:void 0,maxZoom:void 0,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var a=new ol.layer.Tile({source:new ol.source.XYZ({url:e.url,crossOrigin:e.crossOrigin,wrapX:e.wrapX,minZoom:e.minZoom,maxZoom:e.maxZoom}),opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return a.set("name",e.name),a.set("label",e.label),a.set("group",e.group),a.set("type","XYZ"),a},wol.util.createWMSLayer=function(e){var t={name:void 0,label:"",url:"",params:{},serverType:void 0,maxZoom:void 0,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var a=new ol.layer.Tile({source:new ol.source.TileWMS({url:e.url,params:e.params,serverType:e.serverType,wrapX:e.wrapX,maxZoom:e.maxZoom}),opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return a.set("name",e.name),a.set("label",e.label),a.set("group",e.group),a.set("type","WMS"),a},wol.util.createMaskLayer=function(e){var t=wol.util.createFeatureFromWKT("POLYGON((115.282079820752 41.0624818532467,115.282079820752 36.6007452585101,119.034581570745 36.6007452585101,119.034581570745 41.0624818532467,115.282079820752 41.0624818532467))");wol.util.transform(t,"EPSG:4326","EPSG:3857");var a={name:void 0,label:"",features:[t],style:wol.util.styles.MASK_BLACK,updateWhileAnimating:!0,updateWhileInteracting:!0,opacity:1,visible:!1,zIndex:1,group:void 0};e=wol.util.extend(a,e);var r=wol.util.createVectorLayer(e);return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","Mask"),r},wol.util.createHeatMap=function(e){var t={name:void 0,label:"",feature:[],gradient:["#0ff","#00f","#0f0","#ff0","#ff5d3e"],blur:24,radius:10,shadow:300,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var a=new ol.layer.Heatmap({source:new ol.source.Vector({features:e.features}),gradient:e.gradient,blur:e.blur,radius:e.radius,shadow:e.shadow,opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return a.set("name",e.name),a.set("label",e.label),a.set("group",e.group),a.set("type","HeatMap"),a},wol.util.createFeatureFromWKT=function(e){return(new ol.format.WKT).readFeature(e)},wol.util.createWKTFromFeature=function(e){return(new ol.format.WKT).writeFeature(e)},wol.util.transform=function(e,t,a){e.getGeometry().transform(t,a)},wol.util.extend=function e(){var t,a,r,o,n,i,l=arguments[0]||{},s=arguments.length,c=1,u=!1;for("boolean"==typeof l&&(u=l,l=arguments[c]||{},c++),"object"==typeof l||jQuery.isFunction(l)||(l={}),c===s&&(l={},c--);c<s;c++)if(null!=(t=arguments[c]))for(a in t)r=l[a],l!==(o=t[a])&&(u&&o&&(jQuery.isPlainObject(o)||(n=jQuery.isArray(o)))?(n?(n=!1,i=r&&jQuery.isArray(r)?r:[]):i=r&&jQuery.isPlainObject(r)?r:{},l[a]=e(u,i,o)):void 0!==o&&(l[a]=o));return l},wol.util.getColorType=function(e){return/^(rgb[(]|RGB[(]).+([)])$/.test(e)?"RGB":/^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/.test(e)?"HEX":"UNKNOWN"},wol.util.toHexColor=function(e){var t=wol.util.getColorType(e);if("RGB"===t){for(var a=e.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(","),r="#",o=0;o<a.length;o++){var n=Number(a[o]).toString(16);"0"===n&&(n+=n),r+=n}return 7!==r.length&&(r="#000000"),r}if("HEX"!==t)return"#000000";var i=e.replace(/#/,"").split("");if(6===i.length)return e;if(3===i.length){var l="#";for(o=0;o<i.length;o+=1)l+=i[o]+i[o];return l}},wol.util.toRGBColor=function(e){var t=e.toLowerCase(),a=wol.util.getColorType(t);if(t&&"HEX"===a){if(4===t.length){for(var r="#",o=1;o<4;o+=1)r+=t.slice(o,o+1).concat(t.slice(o,o+1));t=r}var n=[];for(o=1;o<7;o+=2)n.push(parseInt("0x"+t.slice(o,o+2)));return"RGB("+n.join(",")+")"}return"RGB(0, 0, 0)"},wol.util.getColorArray=function(e){var t=wol.util.getColorType(e);"HEX"===t?e=wol.util.toRGBColor(e):"RGB"!==t&&(e="RGB(0, 0, 0)");for(var a=e.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(","),r=0;r<a.length;r++)a[r]=parseInt(a[r]);return a}}(window),function(e){e.wol=e.wol||{},wol.MapViewer=function(e,t){var a,r,o,n=0,i={projection:"EPSG:3857",center:[13059385.715379057,4734320.828070238],extent:[],layers:[],zoom:void 0,minZoom:void 0,maxZoom:void 0,controls:{zoom:!0,scaleLine:!0,overviewMap:!1,fullScreen:!1}};t=wol.util.extend(!0,i,t),this.callback={},this.getMap=function(){return a},this.getCurZIndex=function(){return n},this.setCurZIndex=function(e){n=e},r=t,o=new ol.View({center:r.center,projection:r.projection,zoom:r.zoom,minZoom:r.minZoom,maxZoom:r.maxZoom}),a=new ol.Map({target:e,logo:!1,view:o,controls:[]}),this.addLayers(function(e){for(var t=[],a=0;a<e.length;a++)"Vector"===e[a].type?t.push(wol.util.createVectorLayer(e[a])):"Cluster"===e[a].type?t.push(wol.util.createClusterLayer(e[a])):"XYZ"===e[a].type?t.push(wol.util.createXYZLayer(e[a])):"WMS"===e[a].type?t.push(wol.util.createWMSLayer(e[a])):"Mask"===e[a].type?t.push(wol.util.createMaskLayer(e[a])):"HeatMap"===e[a].type?t.push(wol.util.createHeatMap(e[a])):console.warn("Unsupported type of the layer being created.");return t}(t.layers)),function(e,t){if(t.zoom){var a=new ol.control.Zoom;e.addControl(a)}if(t.scaleLine){var r=new ol.control.ScaleLine;e.addControl(r);var o=document.getElementsByClassName("ol-scale-line");o[0].style.left="11px",o[0].style.bottom="8px"}if(t.overviewMap){var n=new ol.control.OverviewMap;e.addControl(n);var o=document.getElementsByClassName("ol-scale-line");if(o.length>0){var i=document.getElementsByClassName("ol-overviewmap");i[0].style.bottom="33px"}}if(t.fullScreen){var l=new ol.control.FullScreen;e.addControl(l)}}(a,t.controls)},wol.MapViewer.prototype.register=function(e,t){this.callback[e]=this.callback[e]?this.callback[e]:[],this.callback[e].push(t)},wol.MapViewer.prototype.getView=function(){return this.getMap().getView()},wol.MapViewer.prototype.getLayers=function(){return this.getMap().getLayers()},wol.MapViewer.prototype.getLayerByName=function(e){for(var t=this.getMap().getLayers(),a=t.getLength(),r=null,o=0;o<a;o++)if(t.item(o).get("name")===e){r=t.item(o);break}return r},wol.MapViewer.prototype.addLayer=function(e){var t=e.getZIndex();if(!t||t<=1){var a=this.getCurZIndex();e.setZIndex(a),this.setCurZIndex(a+1)}this.getMap().addLayer(e);for(var r=this.callback.addLayer||[],o=0;o<r.length;o++)r[o]()},wol.MapViewer.prototype.addLayers=function(e){for(var t=0;t<e.length;t++)this.addLayer(e[t])},wol.MapViewer.prototype.removeLayer=function(e){this.getMap().removeLayer(e);for(var t=this.callback.removeLayer||[],a=0;a<t.length;a++)t[a]()},wol.MapViewer.prototype.removeLayers=function(e){for(var t=0;t<e.length;t++)this.removeLayer(e[t])},wol.MapViewer.prototype.removeLayerByName=function(e){this.getMap().removeLayer(this.getLayerByName(e))},wol.MapViewer.prototype.panTo=function(e,t){var a;a=e instanceof ol.Feature?ol.extent.getCenter(e.getGeometry().getExtent()):e,void 0===t||0===t?this.getView().setCenter(a):this.getView().animate({center:a},{duration:t})},wol.MapViewer.prototype.extentAt=function(e,t){this.getView().fit(e,{size:this.getMap().getSize(),padding:[50,50,50,50],duration:t})}}(window);
