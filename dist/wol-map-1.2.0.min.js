...
!function(e){e.DragHandler=e.DragHandler||{},DragHandler.startDrag=function(e,t){var r=$(t),o=r.parent(),a=e.clientX||e.pageX||e.screenX,n=e.clientY||e.pageY||e.screenY,i=parseFloat(o.css("margin-left")),l=parseFloat(o.css("margin-top")),s=a-i-parseFloat(r.css("margin-left")),c=n-l-parseFloat(r.css("margin-top"));r.attr("conMarginL",i),r.attr("conMarginT",l),r.attr("mouseOffsetX",s),r.attr("mouseOffsetY",c)},DragHandler.dragging=function(e,t,r){var o=$(t),a=e.clientX||e.pageX||e.screenX,n=e.clientY||e.pageY||e.screenY,i=o.attr("conMarginL"),l=o.attr("conMarginT"),s=a-i-o.attr("mouseOffsetX"),c=n-l-o.attr("mouseOffsetY");(o.css("margin-left",s),o.css("margin-top",c),r instanceof Function)&&r(o,{dragMarginL:s,dragMarginT:c})},DragHandler.endDrag=function(e,t){},DragHandler.allowDrop=function(e){e.preventDefault()}}(window),function(e){e.wol=e.wol||{};function u(e,t){var r,o,a,n,i={},l=t.exclude;l=(l=l||[])instanceof Array?l:[l];for(var s=0;s<e.length;s++){r=e[s];for(var c=0;c<l.length;c++)if(r.get("name")===l[c]){a=!0;break}a?a=!1:(void 0===i[o=r.get("group")]&&(i[o]=[]),n={name:r.get("name"),label:r.get("label"),type:r.get("type"),zIndex:r.getZIndex(),checked:r.getVisible()},i[o].push(n))}return i}function g(e){var t,r,o=[];for(var a in e)if("undefined"===a){r=e[a];for(var n=0;n<r.length;n++)t={open:!0,checked:r[n].checked,iconSkin:"layerIcon",name:r[n].label,layerName:r[n].name,type:r[n].type,zIndex:r[n].zIndex},o.push(t)}else{r=e[a],t={open:!1,nocheck:!0,iconSkin:"layersIcon",name:a,children:[]};for(n=0;n<r.length;n++)t.children.push({open:!0,checked:r[n].checked,iconSkin:"layerIcon",name:r[n].label,layerName:r[n].name,type:r[n].type,zIndex:r[n].zIndex});o.push(t)}return o}wol.LayerManager=function(n){var o,a,i=n.getMap(),l={exclude:[]};function s(e){var t={view:{selectedMulti:!1},edit:{enable:!0},check:{enable:!0},data:{simpleData:{enable:!0}},callback:{beforeEditName:function(e,t){return $.fn.zTree.getZTreeObj("treeDemo").selectNode(t),!1},onClick:function(e,t,r){var o="#"+r.tId+"_a";$(o).removeClass("curSelectedNode")},onCheck:function(e,t,r){var o=r.layerName,a=n.getLayerByName(o);r.checked?a.setVisible(!0):a.setVisible(!1)}}};$.fn.zTree.init($("#wolLayerTree0"),t,e)}function c(){var e=u(o,l);s(a=g(e))}this.init=function(e){var t;if(void 0===(l=wol.util.extend(l,e)).target){if((t=$(n.getMap().getTargetElement())).attr("has-tree"))return;t.append('<div class="layer-manager-container in-map pos-absolute" draggable="true" ondragstart="DragHandler.startDrag(event, this)"ondrag="DragHandler.dragging(event, this)" ondragend="DragHandler.endDrag(event, this)"><h4>图层控制</h4><div><ul id="wolLayerTree0" class="ztree"></ul></div></div>')}else{if((t=$("#"+l.target)).attr("has-tree"))return;t.append('<div class="layer-manager-container normal"><div><ul id="wolLayerTree0" class="ztree"></ul></div></div>')}t.attr("has-tree",!0);var r=u(o=i.getLayers().getArray(),l);s(a=g(r)),n.register("addLayer",c),n.register("removeLayer",c)},this.getMap=function(){return i},this.getLayers=function(){return o},this.getTreeData=function(){return a}}}(window),function(e){e.wol=e.wol||{},wol.Locator=function(e){var t,r=e,o={STATIC:new ol.style.Style({stroke:new ol.style.Stroke({color:"#00afcc",width:2}),fill:new ol.style.Fill({color:"#00e3ff"}),image:new ol.style.Circle({stroke:new ol.style.Stroke({color:"#8fedce",width:2}),fill:new ol.style.Fill({color:"#00c38a"}),radius:8})}),FLASH:new ol.style.Style({stroke:new ol.style.Stroke({color:"#ff93a8",width:2}),fill:new ol.style.Fill({color:"#ff607f"}),image:new ol.style.Circle({stroke:new ol.style.Stroke({color:"#ff93a8",width:2}),fill:new ol.style.Fill({color:"#ff607f"}),radius:8})})};this.getMapViewer=function(){return r},this.getLocateLayer=function(){return t},this.getLocateSource=function(){return t.getSource()},this.getStaticStyle=function(){return o.STATIC},this.setStaticStyle=function(e){o.STATIC=e,this.getLocateLayer().setStyle(e)},this.getFlashStyle=function(){return o.FLASH},this.setFlashStyle=function(e){o.FLASH=e},this.getPiStrokeColor=function(){return o.FLASH.getImage().getStroke().getColor()},this.getPiFillColor=function(){return o.FLASH.getImage().getFill().getColor()},this.getPiRadius=function(){return o.FLASH.getImage().getRadius()},this.getLsStrokeColor=function(){return o.FLASH.getStroke().getColor()},this.getPlStrokeColor=function(){return o.FLASH.getStroke().getColor()},this.getPlFillColor=function(){return o.FLASH.getFill().getColor()},t=wol.util.createVectorLayer({name:"locateLayer"+(new Date).getTime(),label:"定位图层",style:o.STATIC,updateWhileAnimating:!0,zIndex:30}),e.addLayer(t)},wol.Locator.prototype.locate=function(e,t){e.get("locating")?console.warn("The feature is being located."):(e.set("locating",!0),t=wol.util.extend(!0,{duration:0,times:3,autoView:!0},t),this.locateProxy(e,t.duration,t.times,t.autoView))},wol.Locator.prototype.locateProxy=function(e,t,r,o){o&&this.getMapViewer().getView().fit(e.getGeometry(),{size:mapViewer.getMap().getSize(),padding:[50,50,50,50],duration:600});var a=this,n=!1,i=e.clone(),l="locate"+i.getGeometry().getType(),s=i.getGeometry().getType();if("Point"===s||"LineString"===s||"Polygon"===s)if("Point"===s&&(n=!1),-1===r)setInterval(function(){a[l](i,t)},t),a[l](i,t);else if(0<r){var c=0,u=setInterval(function(){if(r-1<++c)return clearInterval(u),e.set("locating",!1),void(n&&a.getLocateSource().removeFeature(i));a[l](i,t)},t);a[l](i,t)}else setTimeout(function(){e.set("locating",!1),n&&a.getLocateSource().removeFeature(i)},t);else console.error("Unsupported type of feature to locate.")},wol.Locator.prototype.locatePoint=function(l,s){var c,u=this,g=u.getMapViewer().getMap(),p=(s=s,(new Date).getTime());c=g.on("postcompose",function(e){var t=e.vectorContext,r=e.frameState,o=l.getGeometry(),a=r.time-p,n=a/s,i=u.createPointFlashStyle(n,5,u.getPiRadius());t.setStyle(i),t.drawGeometry(o),s<a?ol.Observable.unByKey(c):g.render()}),g.render()},wol.Locator.prototype.locateLineString=function(l,s){var c,u=this,g=u.getMapViewer().getMap(),p=(s=s,(new Date).getTime());c=g.on("postcompose",function(e){var t=e.vectorContext,r=e.frameState,o=l.getGeometry(),a=r.time-p,n=a/s,i=u.createLineFlashStyle(n);if(t.setStyle(i),t.drawGeometry(o),s<a)return ol.Observable.unByKey(c),void g.render();g.render()}),g.render()},wol.Locator.prototype.locatePolygon=function(l,s){var c,u=this,g=u.getMapViewer().getMap(),p=(s=s,(new Date).getTime());c=g.on("postcompose",function(e){var t=e.vectorContext,r=e.frameState,o=l.getGeometry(),a=r.time-p,n=a/s,i=u.createAreaFlashStyle(n);if(t.setStyle(i),t.drawGeometry(o),s<a)return ol.Observable.unByKey(c),void g.render();g.render()}),g.render()},wol.Locator.prototype.createPointFlashStyle=function(e,t,r){var o=ol.easing.easeOut(e)*r+t,a=ol.easing.easeOut(1-e),n=wol.util.getColorArray(this.getPiStrokeColor());return new ol.style.Style({image:new ol.style.Circle({radius:o,snapToPixel:!1,stroke:new ol.style.Stroke({color:"rgba("+n[0]+", "+n[1]+", "+n[2]+", "+a+")",width:2.2})})})},wol.Locator.prototype.createLineFlashStyle=function(e){var t=ol.easing.upAndDown(1-e),r=wol.util.getColorArray(this.getLsStrokeColor());return new ol.style.Style({stroke:new ol.style.Stroke({color:"rgba("+r[0]+", "+r[1]+", "+r[2]+", "+t+")",width:4})})},wol.Locator.prototype.createAreaFlashStyle=function(e){var t=ol.easing.upAndDown(e),r=wol.util.getColorArray(this.getPlStrokeColor()),o=wol.util.getColorArray(this.getPlFillColor());return new ol.style.Style({stroke:new ol.style.Stroke({color:"rgba("+r[0]+", "+r[1]+", "+r[2]+", "+t+")",width:4}),fill:new ol.style.Fill({color:"rgba("+o[0]+", "+o[1]+", "+o[2]+", "+t+")"})})}}(window),function(e){e.wol=e.wol||{};var t,r,p=1,m=5,f=10,o=decodeURI((t=document.getElementsByTagName("script"),(r=t[t.length-1]).hasAttribute?r.src:r.getAttribute("src"))).split("/");o.pop();var i=o.join("/")+"/image/drone.gif";function y(e){e.animateParam.flashCoords=[e.animateParam.srcCoords[0]],e.animateParam.index=0}function a(e,t,r){var o=e.getView(),a=50;r&&(a=r<=5?100:5<r&&r<=9?50:0),r&&0<a?o.animate({center:t},{duration:a}):(o.setZoom(15),o.setCenter(t))}wol.Tracer=function(t){var r,s,c,u,e,o,a=t,n={source:null,speed:m,afterInitialize:function(){},afterStart:function(){},afterComplete:function(){},icon:i,iconClass:"",iconSize:40,iconOpacity:1,ifDynamicTrack:!1,ifLocate:!1},g={STATIC_LINE:new ol.style.Style({stroke:new ol.style.Stroke({color:"#374f62",width:2,lineDash:[6,4]})}),FLASH_LINE:new ol.style.Style({stroke:new ol.style.Stroke({color:"#23e6a1",width:3})}),FLASH_POINT:(e={src:i,opacity:.95},o={anchor:[.5,1],anchorXUnits:"fraction",anchorYUnits:"fraction",src:i,scale:1,opacity:1},e=wol.util.extend(o,e),new ol.style.Style({image:new ol.style.Icon({anchor:e.anchor,anchorXUnits:e.anchorXUnits,anchorYUnits:e.anchorYUnits,src:e.src,scale:e.scale,opacity:e.opacity})}))};this.status={initialize:!1,start:!1,animating:!1,complete:!1},this.timer=null,this.animateParam={},this.init=function(e){this.status.initialize?console.error("轨迹已初始化"):(function(e,t){var r=e.source;if(!(null!==r&&r instanceof ol.Feature&&r.getGeometry()instanceof ol.geom.LineString))return console.error("参数错误");var o=e.speed;o="slow"===o?p:"normal"===o?m:"fast"===o?f:isNaN(o)?1:parseFloat(o);e.speed=o;var a=(s=r).getGeometry().getCoordinates(),n=wol.util.splitCoordinates(a,e.speed);c=new ol.Feature(new ol.geom.LineString([a[0]])),u=new ol.Overlay({element:(i={icon:e.icon,clas:e.iconClass,size:e.iconSize,opacity:e.iconOpacity},l=document.createElement("div"),l.style.width=i.size+"px",l.style.height=i.size+"px",l.className=i.clas,l.style.background="url("+i.icon+") no-repeat",l.style.backgroundSize=i.size+"px",l.style.opacity=i.opacity,l),position:a[0],positioning:"center-center"}),s.setStyle(g.STATIC_LINE),c.setStyle(g.FLASH_LINE),t.animateParam.speed=e.speed,t.animateParam.srcCoords=n,t.animateParam.tempCoord=n[0],t.animateParam.coordLen=n.length,t.animateParam.flashLineGeom=c.getGeometry(),t.animateParam.flashPointOverlay=u,t.animateParam.afterInitialize=e.afterInitialize,t.animateParam.afterStart=e.afterStart,t.animateParam.afterComplete=e.afterComplete,t.animateParam.ifDynamicTrack=e.ifDynamicTrack,y(t);var i,l}(e=wol.util.extend(n,e),this),r=wol.util.createVectorLayer({name:"traceLayer"+(new Date).getTime(),label:"轨迹图层",style:g.STATIC,features:[s,c],updateWhileAnimating:!0,updateWhileInteracting:!0,zIndex:25}),t.addLayer(r),t.getMap().addOverlay(u),this.status.initialize=!0,this.animateParam.afterInitialize(),e.ifLocate&&this.getMapViewer().panTo(this.animateParam.tempCoord,400))},this.getMapViewer=function(){return a},this.getTraceLayer=function(){return r},this.getTraceSource=function(){return r.getSource()},this.getTraceLine=function(){return s},this.getFlashLine=function(){return c},this.getFlashPoint=function(){}},wol.Tracer.prototype.play=function(){var o=this,e=0;if(o.status.initialize){if(o.status.start){if(o.status.animating)return void console.info("动画正在播放");if(o.status.complete)return void console.info("动画已结束")}else o.status.start=!0,o.animateParam.afterStart(),o.animateParam.ifDynamicTrack?o.getMapViewer().getMap().getView().setZoom(15):(a(o.getMapViewer().getMap(),o.animateParam.tempCoord,o.animateParam.speed),e=100);setTimeout(function(){o.status.animating=!0,o.timer=setInterval(function(){var e,t,r;o.animateParam.index<o.animateParam.coordLen-1?(o.animateParam.tempCoord=o.animateParam.srcCoords[o.animateParam.index+1],o.animateParam.flashCoords.push(o.animateParam.tempCoord),o.animateParam.flashLineGeom.setCoordinates(o.animateParam.flashCoords),o.animateParam.flashPointOverlay.setPosition(o.animateParam.tempCoord),o.animateParam.ifDynamicTrack?o.getMapViewer().panTo(o.animateParam.tempCoord,0):(e=o.getMapViewer().getMap(),t=o.animateParam.tempCoord,r=e.getView().calculateExtent(e.getSize()),ol.extent.containsCoordinate(r,t)||a(o.getMapViewer().getMap(),o.animateParam.tempCoord,o.animateParam.speed)),o.animateParam.index++):(clearInterval(o.timer),o.status.animating=!1,o.status.complete=!0,o.animateParam.afterComplete())},5)},e)}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.pause=function(){this.status.animating?(clearInterval(this.timer),this.status.animating=!1):console.error("动画未处于播放状态")},wol.Tracer.prototype.reset=function(){var e=this;if(e.status.initialize){clearInterval(e.timer),e.status.start=!1,e.status.animating=!1,y(e);var t=e.animateParam.srcCoords[0];e.animateParam.flashLineGeom.setCoordinates(e.animateParam.flashCoords),e.animateParam.flashPointOverlay.setPosition(t),e.animateParam.tempCoord=t,e.getMapViewer().panTo(t,600)}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.clear=function(){var e=this;if(e.status.initialize){clearInterval(e.timer),e.status.initialize=!1,e.status.start=!1,e.status.animating=!1,e.status.complete=!1,y(e);var t=e.getTraceSource();t.removeFeature(e.getTraceLine()),t.removeFeature(e.getFlashLine()),t.removeFeature(e.getFlashPoint())}else console.error("轨迹已销毁或未初始化")},wol.Tracer.prototype.setStaticStyle=function(e){this.getTraceLine().setStyle(e)},wol.Tracer.prototype.setFlashStyle=function(e){this.getFlashLine().setStyle(e)}}(window),function(e){function i(e,t,r){var o,a,n,i,l=e[0],s=e[1],c=t[0],u=t[1],g=[e],p=l<c?1:-1,m=s<u?1:-1;if(s===u)for(o=l+(n=p*r),a=s;0<p?o<c:c<o;)g.push([o,a]),o+=n;else if(l===c)for(o=l,a=s+(i=m*r);0<p?a<u:u<a;)g.push([o,a]),a+=i;else{var f=Math.abs((u-s)/(c-l)),y=r/Math.pow(1+f*f,.5);for(o=l+(n=p*y),a=s+(i=m*(y*f));0<p?o<c:c<o;)g.push([o,a]),o+=n,a+=i}return g.push(t),g}e.wol=e.wol||{},e.wol.util=e.wol.util||{},wol.util.styles={DEFAULT_STYLE:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(0, 191, 255, 0.5)"}),image:new ol.style.Circle({fill:new ol.style.Fill({color:"#00bfff"}),stroke:new ol.style.Stroke({color:"#bdecff",width:2}),radius:8}),stroke:new ol.style.Stroke({color:"#00bfff",width:3})}),TEXT_STYLE:new ol.style.Style({text:new ol.style.Text({text:"",offsetY:18,font:"14px 微软雅黑",textAlign:"center",fill:new ol.style.Fill({color:"#2d2d2d"})})}),MASK_BLACK:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(0, 0, 0, 0.5)"})})},wol.util.createVectorLayer=function(e){var t={name:void 0,label:"",style:wol.util.styles.DEFAULT_STYLE,features:[],updateWhileAnimating:!0,updateWhileInteracting:!1,useSpatialIndex:!1,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var r=new ol.layer.Vector({source:new ol.source.Vector({features:e.features,useSpatialIndex:e.useSpatialIndex}),style:e.style,updateWhileAnimating:e.updateWhileAnimating,updateWhileInteracting:e.updateWhileInteracting,opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","Vector"),r},wol.util.createClusterLayer=function(r){var o={},e={name:void 0,label:"",styleFunction:function(e){var t=e.get("features").length,r=o[t];return r||(r=new ol.style.Style({image:new ol.style.Circle({radius:10,stroke:new ol.style.Stroke({color:"#fff"}),fill:new ol.style.Fill({color:"#3399CC"})}),text:new ol.style.Text({text:t.toString(),fill:new ol.style.Fill({color:"#fff"})})}),o[t]=r),r},features:[],updateWhileAnimating:!0,updateWhileInteracting:!1,opacity:1,visible:!0,zIndex:void 0,group:void 0};r=wol.util.extend(e,r);var t=new ol.layer.Vector({source:new ol.source.Cluster({distance:40,source:new ol.source.Vector({features:r.features})}),style:function(e,t){return r.styleFunction(e,t)},updateWhileAnimating:r.updateWhileAnimating,updateWhileInteracting:r.updateWhileInteracting,opacity:r.opacity,visible:r.visible,zIndex:r.zIndex});return t.set("name",r.name),t.set("label",r.label),t.set("group",r.group),t.set("type","Cluster"),t},wol.util.createXYZLayer=function(e){var t={name:void 0,label:"",url:"",crossOrigin:void 0,minZoom:void 0,maxZoom:void 0,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var r=new ol.layer.Tile({source:new ol.source.XYZ({url:e.url,crossOrigin:e.crossOrigin,wrapX:e.wrapX,minZoom:e.minZoom,maxZoom:e.maxZoom}),opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","XYZ"),r},wol.util.createWMSLayer=function(e){var t={name:void 0,label:"",url:"",params:{},serverType:void 0,maxZoom:void 0,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var r=new ol.layer.Tile({source:new ol.source.TileWMS({url:e.url,params:e.params,serverType:e.serverType,wrapX:e.wrapX,maxZoom:e.maxZoom}),opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","WMS"),r},wol.util.createMaskLayer=function(e){var t={name:void 0,label:"",features:[wol.util.createFeatureFromWKT("POLYGON((8140237.764258131 7592337.145509984,8218509.281222153 313086.06785608083,15889117.94369616 313086.06785608083,15732574.909768116 7514065.628545966,8140237.764258131 7592337.145509984))")],style:wol.util.styles.MASK_BLACK,updateWhileAnimating:!0,updateWhileInteracting:!0,opacity:1,visible:!1,zIndex:1,group:void 0};e=wol.util.extend(t,e);var r=wol.util.createVectorLayer(e);return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","Mask"),r},wol.util.createHeatMap=function(e){var t={name:void 0,label:"",feature:[],gradient:["#0ff","#00f","#0f0","#ff0","#ff5d3e"],blur:24,radius:10,shadow:300,opacity:1,visible:!0,zIndex:void 0,group:void 0};e=wol.util.extend(t,e);var r=new ol.layer.Heatmap({source:new ol.source.Vector({features:e.features}),gradient:e.gradient,blur:e.blur,radius:e.radius,shadow:e.shadow,opacity:e.opacity,visible:e.visible,zIndex:e.zIndex});return r.set("name",e.name),r.set("label",e.label),r.set("group",e.group),r.set("type","HeatMap"),r},wol.util.createFeatureFromWKT=function(e){return(new ol.format.WKT).readFeature(e)},wol.util.createWKTFromFeature=function(e){return(new ol.format.WKT).writeFeature(e)},wol.util.transform=function(e,t,r){e.getGeometry().transform(t,r)},wol.util.extend=function e(){var t,r,o,a,n,i,l=arguments[0]||{},s=arguments.length,c=1,u=!1;for("boolean"==typeof l&&(u=l,l=arguments[c]||{},c++),"object"==typeof l||wol.util.isFunction(l)||(l={}),c===s&&(l={},c--);c<s;c++)if(null!=(t=arguments[c]))for(r in t)o=l[r],l!==(a=t[r])&&(u&&a&&(wol.util.isPlainObject(a)||(n=Array.isArray(a)))?(i=n?(n=!1,o&&Array.isArray(o)?o:[]):o&&wol.util.isPlainObject(o)?o:{},l[r]=e(u,i,a)):void 0!==a&&(l[r]=a));return l},wol.util.isFunction=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},wol.util.isPlainObject=function(e){var t,r;return!(!e||"[object Object]"!==e.toString())&&(!(t=Object.getPrototypeOf(e))||"function"==typeof(r=t.hasOwnProperty("constructor")&&t.constructor)&&"[object Object]"===r.toString())},wol.util.getColorType=function(e){return/^(rgb[(]|RGB[(]).+([)])$/.test(e)?"RGB":/^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/.test(e)?"HEX":"UNKNOWN"},wol.util.toHexColor=function(e){var t=wol.util.getColorType(e);if("RGB"===t){for(var r=e.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(","),o="#",a=0;a<r.length;a++){var n=Number(r[a]).toString(16);"0"===n&&(n+=n),o+=n}return 7!==o.length&&(o="#000000"),o}if("HEX"!==t)return"#000000";var i=e.replace(/#/,"").split("");if(6===i.length)return e;if(3===i.length){var l="#";for(a=0;a<i.length;a+=1)l+=i[a]+i[a];return l}},wol.util.toRGBColor=function(e){var t=e.toLowerCase(),r=wol.util.getColorType(t);if(t&&"HEX"===r){if(4===t.length){for(var o="#",a=1;a<4;a+=1)o+=t.slice(a,a+1).concat(t.slice(a,a+1));t=o}var n=[];for(a=1;a<7;a+=2)n.push(parseInt("0x"+t.slice(a,a+2)));return"RGB("+n.join(",")+")"}return"RGB(0, 0, 0)"},wol.util.getColorArray=function(e){var t=wol.util.getColorType(e);"HEX"===t?e=wol.util.toRGBColor(e):"RGB"!==t&&(e="RGB(0, 0, 0)");for(var r=e.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(","),o=0;o<r.length;o++)r[o]=parseInt(r[o]);return r},wol.util.splitCoordinates=function(e,t){var r=e.length;if(2<=r){for(var o,a=0,n=[];a<r-1;a++)o=i(e[a],e[a+1],t),n=n.concat(o);return n}throw new Error("至少包含两个点")},wol.util.createShadowFeature=function(e,t){var r=t.getGeometry().getCoordinates(),o=r[0],a=r[1],n=(a[1]-o[1])/(a[0]-o[0]),i=Math.sqrt(Math.pow(n,2)-1),l=[o[0]+1*n/i,o[1]-1/i],s=[a[0]+1*n/i,a[1]-1/i];console.info(l,s);var c=new ol.Feature({geometry:new ol.geom.LineString([l,s])}),u=new ol.style.Style({stroke:new ol.style.Stroke({color:"white",width:5})});e.on("postcompose",function(e){var t=e.vectorContext,r=c.getGeometry();t.setStyle(u),t.drawGeometry(r)})}}(window),function(e){e.wol=e.wol||{},wol.MapViewer=function(e,t){var r,o,a,n=0,i={projection:"EPSG:3857",center:[13059385.715379057,4734320.828070238],extent:[],layers:[],zoom:void 0,minZoom:void 0,maxZoom:void 0,controls:{zoom:!0,scaleLine:!0,overviewMap:!1,fullScreen:!1}};t=wol.util.extend(!0,i,t),this.callback={},this.getMap=function(){return r},this.getCurZIndex=function(){return n},this.setCurZIndex=function(e){n=e},o=t,a=new ol.View({center:o.center,projection:o.projection,zoom:o.zoom,minZoom:o.minZoom,maxZoom:o.maxZoom}),r=new ol.Map({target:e,logo:!1,view:a,controls:[]}),this.addLayers(function(e){for(var t=[],r=0;r<e.length;r++)"Vector"===e[r].type?t.push(wol.util.createVectorLayer(e[r])):"Cluster"===e[r].type?t.push(wol.util.createClusterLayer(e[r])):"XYZ"===e[r].type?t.push(wol.util.createXYZLayer(e[r])):"WMS"===e[r].type?t.push(wol.util.createWMSLayer(e[r])):"Mask"===e[r].type?t.push(wol.util.createMaskLayer(e[r])):"HeatMap"===e[r].type?t.push(wol.util.createHeatMap(e[r])):console.warn("Unsupported type of the layer being created.");return t}(t.layers)),function(e,t){if(t.zoom){var r=new ol.control.Zoom;e.addControl(r)}if(t.scaleLine){var o=new ol.control.ScaleLine;e.addControl(o);var a=document.getElementsByClassName("ol-scale-line");a[0].style.left="11px",a[0].style.bottom="8px"}if(t.overviewMap){var n=new ol.control.OverviewMap;e.addControl(n);var a=document.getElementsByClassName("ol-scale-line");if(0<a.length){var i=document.getElementsByClassName("ol-overviewmap");i[0].style.bottom="33px"}}if(t.fullScreen){var l=new ol.control.FullScreen;e.addControl(l)}}(r,t.controls)},wol.MapViewer.prototype.register=function(e,t){this.callback[e]=this.callback[e]?this.callback[e]:[],this.callback[e].push(t)},wol.MapViewer.prototype.getView=function(){return this.getMap().getView()},wol.MapViewer.prototype.getLayers=function(){return this.getMap().getLayers()},wol.MapViewer.prototype.getLayerByName=function(e){for(var t=this.getMap().getLayers(),r=t.getLength(),o=null,a=0;a<r;a++)if(t.item(a).get("name")===e){o=t.item(a);break}return o},wol.MapViewer.prototype.addLayer=function(e){var t=e.getZIndex();if(!t||t<=1){var r=this.getCurZIndex();e.setZIndex(r),this.setCurZIndex(r+1)}this.getMap().addLayer(e);for(var o=this.callback.addLayer||[],a=0;a<o.length;a++)o[a]()},wol.MapViewer.prototype.addLayers=function(e){for(var t=0;t<e.length;t++)this.addLayer(e[t])},wol.MapViewer.prototype.removeLayer=function(e){this.getMap().removeLayer(e);for(var t=this.callback.removeLayer||[],r=0;r<t.length;r++)t[r]()},wol.MapViewer.prototype.removeLayers=function(e){for(var t=0;t<e.length;t++)this.removeLayer(e[t])},wol.MapViewer.prototype.removeLayerByName=function(e){this.getMap().removeLayer(this.getLayerByName(e))},wol.MapViewer.prototype.panTo=function(e,t){var r;r=e instanceof ol.Feature?ol.extent.getCenter(e.getGeometry().getExtent()):e,void 0===t||0===t?this.getView().setCenter(r):this.getView().animate({center:r},{duration:t})},wol.MapViewer.prototype.extentAt=function(e,t){this.getView().fit(e,{size:this.getMap().getSize(),padding:[50,50,50,50],duration:t})}}(window);
